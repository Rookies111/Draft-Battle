...
import { world, system, EasingType, ItemStack, GameMode } from "@minecraft/server"
import { chooseFromArray } from "./util.js"
import { gotoArena } from "./battle.js"

// Define the runId_queue
let runId_queue = []
...
export function GameStart(runId_queue) {
    ...
    players.forEach(player => TradingHallCutscene(player))
}

// Function to play the trading hall cutscene
function TradingHallCutscene(player) {
